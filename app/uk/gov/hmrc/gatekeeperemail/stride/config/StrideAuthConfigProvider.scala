...
package uk.gov.hmrc.gatekeeperemail.stride.config
...
class StrideAuthConfigProvider @Inject() (configuration: Configuration) extends Provider[StrideAuthConfig] with BaseUrl {
  ...
  override def get(): StrideAuthConfig = {
    ...
    StrideAuthConfig(authBaseUrl, strideLoginUrl, origin, adminRole, superUserRole, advancedUserRole, userRole, successUrlBase)
  }
}
